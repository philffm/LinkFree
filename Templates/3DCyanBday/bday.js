...
switch(websiteMode) {
    ...
    case '10000':
        ...
        document.querySelectorAll('.emoji')[0].innerHTML = ('🎈')
        document.querySelectorAll('.invite')[0].innerHTML += ("Dear friend, multiple occations to celebrate: <br> - 1st I'm back to Frankfurt 🌆<br> - 2nd Although my actual birthday is on the 23rd of June, this year there is another special birthday to celebrate: I turned 10.000 days on November 9th");
        document.querySelectorAll('.rsvp h2')[0].innerHTML = ("RSVP");
        // document.querySelectorAll('.whatsappgroup')[0].innerHTML = ("If you fancy joining a WhatsApp group (for photos and stuff) :)");
